...
root = Tk()
# la fonction mouse_press qui donne les coordonnées de la point cliquée par la sourie
...
canvas = Canvas(root, width=640,height = 480, background ='pink')
canvas.pack()
#la fonction qui crée la ligne
def draw(event):
    global prev
